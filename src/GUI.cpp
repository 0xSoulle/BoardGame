...
GUI::GUI(Game* game) : game(game), running(true) {
    initSDL();
}
    ...
    while (SDL_PollEvent(&event)) {
        if (event.type == SDL_QUIT) {
            ...
            if (event.key.keysym.sym == SDLK_ESCAPE) {
                ...
                std::string event_msg = "Player " + player.getName() + " rolled " + std::to_string(dice);
                switch (event_type) {
                    case 0: event_msg += " - FREEZE!"; break;
                    case 1: event_msg += " - JUMP +9!"; break;
                    case 2: event_msg += " - FALL -9!"; break;
                    case 3: event_msg += " - CRAB!"; break;
                    case 4: event_msg += " - HELL!"; break;
                    case 5: event_msg += " - DEATH!"; break;
                }
